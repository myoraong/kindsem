    ...
    <div className="mx-auto w-full max-w-3xl px-4 py-8 md:py-12">
      ...
      <div className="mt-6 space-y-5 text-pretty break-keep text-sm leading-7 text-muted-foreground">
        ...
        <p>
          ...
          신용카드·보험료, 부양가족 추가 공제 세목, 미성년 증여 추가 한도의 특례, 수도권
          주택담보대출 절대한도, 스트레스 DSR 가산, 법무사 보수 시세가 그렇습니다. 실수령의 이번 달
          명세서는 소득세법 시행령 별표 2(2026.2.27.)를 그대로 넣습니다. 그 표는 하루 두 번 받는
          갱신에 아직 없어서, 별표가 개정되면 그때 다시 넣습니다. 빠진 줄이

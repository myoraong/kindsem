...
따뜻한 크림 종이 위에 부드러운 세이지 그린입니다. 눈 편한 색감으로, 이름처럼 부담 없이 쓰도록 맞췄습니다. 마스코트 **세나**는 셈과 나(내가 세어 줄게요)를 붙인 이름입니다. 크림색 곰이 세이지 계산기와 영수증을 들고 있습니다. 검색 파비콘은 세이지 배경 위 세나 얼굴이고, 헤더·홈·하단은 같은 세나를 씁니다. 구글 결과의 아이콘은 파비콘 URL을 바꾼 뒤에도 며칠 걸릴 수 있습니다.

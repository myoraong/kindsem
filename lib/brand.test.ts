...
test("세나 그림 파일이 공개 폴더에 있다", () => {
  ...
  assert.equal(existsSync(join(root, "kindsem-sena-share-live.png")), true)
  assert.equal(existsSync(join(root, "kindsem-sena-live.png")), true)
  assert.equal(existsSync(join(root, "kindsem-sena-calc-live.png")), true)
  assert.equal(existsSync(join(root, "kindsem-sena-face-live.png")), true)
  ...
  assert.equal(existsSync(join(root, "kindsem-sena-face-fav-48.png")), true)
  assert.equal(existsSync(join(root, "kindsem-sena-face-fav-96.png")), true)
  assert.equal(existsSync(join(root, "kindsem-sena-face-fav-192.png")), true)

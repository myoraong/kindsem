...
const ALIASES: Record<string, string[]> = {
  ...
  "sale-vat": ["부가세", "부가가치세", "할인", "세일", "vat", "부가세포함", "부가세별도", "할인율"],
  "vehicle-tax": ["취등록세", "차량취득세", "자동차취득세", "출고세금"],
  "car-tax": ["자동차세", "보유자동차세", "배기량세", "차령", "자동차세계산기", "자동차세연납", "자동차세조회"],
  "import-duty": ["해외직구", "관세", "직구", "목록통관", "소액면세", "부가세", "직구세금", "관세부가세"],
  ...
  "min-wage": ["최저임금", "최저시급", "최저임금월급", "시급최저", "시급계산", "월급시급", "2026최저시급"],
  "part-time-month": ["알바월급", "시급월급", "알바비", "알바시급", "시급주휴"],
  "prorate-pay": ["일할", "월급일할", "퇴사정산", "입사정산"],
  "overtime-pay": ["연장", "야간", "휴일수당", "연장수당", "야간수당", "야근수당", "잔업", "잔업수당", "특근", "초과근무"],
  "parental-leave": ["육아휴직", "육휴", "육아휴직급여"],
  "maternity-leave": ["출산전후휴가", "출산휴가", "출산휴가급여", "출산전후"],
  "annual-leave": ["연차", "연차수당", "연차일수", "연차발생", "미사용연차", "휴가"],
  severance: ["퇴직", "퇴직금", "평균임금", "퇴직금계산기"],
  "retirement-tax": ["퇴직소득세", "퇴직금세금", "퇴직소득", "퇴직원천징수"],
  "offer-compare": ["이직", "연봉비교", "제안", "세후비교", "이직연봉"],
  "side-job-tax": ["알바", "3.3", "3.3%", "프리랜서", "종소세", "종합소득세", "원천징수"],
  "benefit-net": ["실업급여", "내일배움", "지원금", "구직급여", "실업급여계산기"],
  "cert-payback": ["자격증", "자격"],
  brokerage: ["복비", "복비얼마", "중개", "중개보수", "수수료", "복비계산기", "중개수수료계산기"],
  moving: ["이사", "이사비용", "이사비"],
  jeonse: ["전세대출", "전세이자", "전세자금대출", "전세이자계산기"],
  "rent-convert": ["전월세", "전환율", "반전세", "월세전환", "전월세전환율계산기"],
  ...
  pyeong: ["평", "평수", "제곱미터", "평당", "평당가", "면적", "m2", "평변환", "평수계산기"],
  ltv: ["엘티비", "주택담보비율"],
  dsr: ["디에스알", "총부채원리금"],
  "loan-interest": ["대출이자", "대출상환", "원리금균등", "원금균등", "만기일시"],
  mortgage: ["주담대", "주택담보", "원리금", "주택담보대출계산기", "주담대이자"],
  yield: ["수익률", "임대수익", "월세수익률", "임대수익률계산기"],
}

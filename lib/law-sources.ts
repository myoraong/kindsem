...
export const LAW_SOURCES = {
  ...
  gift: fromPolicy(
    "gift",
    "상속세 및 증여세법 제18조·제19조·제20조·제21조·제22조·제26조·제47조·제53조",
    "https://www.law.go.kr/법령/상속세 및 증여세법",
    "일괄공제 5억, 자녀 1인 5천만, 배우자공제 최소 5억·한도 30억, 금융재산공제 한도 2억. 증여는 10년 합산입니다.",
  ),
  holding: fromPolicy(
    "holding",
  ...
  carTax: fromPolicy(
    "local",
    "지방세법 제127조·제128조·제151조, 시행령 제125조",
    "https://www.law.go.kr/법령/지방세법",
    "비영업 승용 cc당 80·140·200원. 차령 3년차부터 5%씩, 12년 50%. 전기 등 비영업 10만 원. 교육세는 공제 뒤 30%. 연납 이자 5%.",
  ),
  interest: fromPolicy(
    "income",

...
export const CALCULATORS: CalcItem[] = [
  {
    slug: "quick",
    title: "바로 계산",
    blurb: "더하기·나누기·비율을 치면 기록이 이 기기에 남습니다.",
  ...
  },
  {
    slug: "benefit-net",
    title: "실업·훈련 지원금",
    blurb: "실업급여와 훈련장려금이 통장에 얼마나 붙는지 봅니다.",
  ...
  },
  {
    slug: "cert-payback",
    title: "자격증 회수",
    blurb: "수강·응시료가 세후 연봉 상승으로 몇 달에 돌아오는지 봅니다.",
    when: "자격증 수강 전에",
    group: "work",
  },
  {
  ...
  },
  {
    slug: "dsr",
    title: "DSR",
    blurb: "한 해 소득으로 모든 대출 원리금을 갚을 수 있는지, 은행은 40%까지 봅니다.",
    when: "소득 대비 원리금 한도",
    group: "loan",
  },
  {

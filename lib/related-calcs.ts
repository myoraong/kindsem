...
const RELATED: Record<string, string[]> = {
  ...
  severance: ["retirement-tax", "take-home", "annual-leave"],
  "retirement-tax": ["severance", "take-home", "annual-leave"],
  ...
  acquisition: ["closing-cost", "holding-tax", "capital-gains"],
  "gift-tax": ["inheritance", "encumbered-gift", "license-tax"],
  inheritance: ["gift-tax", "license-tax", "encumbered-gift"],
  "encumbered-gift": ["gift-tax", "inheritance", "capital-gains"],
  "closing-cost": ["acquisition", "pyeong", "brokerage"],
  "capital-gains": ["holding-tax", "acquisition", "corporate-gains"],
  "corporate-gains": ["capital-gains", "holding-tax", "acquisition"],
  "holding-tax": ["acquisition", "capital-gains", "closing-cost"],
  "license-tax": ["gift-tax", "inheritance", "encumbered-gift"],
  ...
  yield: ["pyeong", "rent-convert", "jeonse-vs-rent"],
  pyeong: ["acquisition", "closing-cost", "yield"],
  "import-duty": ["sale-vat", "vehicle-tax", "car-tax"],
  "sale-vat": ["import-duty", "vehicle-tax", "car-tax"],
  dutch: ["ladder", "quick", "sale-vat"],
  ladder: ["dutch", "quick", "sale-vat"],
  "vehicle-tax": ["car-tax", "import-duty", "sale-vat", "deposit"],
  "car-tax": ["vehicle-tax", "import-duty", "sale-vat", "deposit"],
  deposit: ["take-home", "loan-interest", "dsr"],

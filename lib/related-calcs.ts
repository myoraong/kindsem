...
const RELATED: Record<string, string[]> = {
  ...
  jeonse: ["jeonse-vs-rent", "rent-convert", "moving"],
  ...
  mortgage: ["ltv", "dsr", "acquisition"],
  ltv: ["dsr", "mortgage", "acquisition"],
  dsr: ["ltv", "mortgage", "jeonse"],
